<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:72:"E:\wamp\www\thinkphp\public/../application/admin/view/article/index.html";i:1496457307;s:63:"E:\wamp\www\thinkphp\public/../application/admin/view/base.html";i:1496560042;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8"/>
    ...
    <div class="panel panel-default">
        <div class="panel-body">
            <table class="table table-hover">
                ...
                <tbody>
                <?php if(is_array($field) || $field instanceof \think\Collection || $field instanceof \think\Paginator): if( count($field)==0 ) : echo "" ;else: foreach($field as $key=>$value): ?>
                <tr>
                    <td><?php echo $value['arc_id']; ?></td>
                    <td><?php echo $value['arc_title']; ?></td>
                    <td><?php echo $value['arc_author']; ?></td>
                    <td>
                        <input type="text" class="form-control" value="<?php echo $value['arc_sort']; ?>" onblur="changeSort(this,<?php echo $value['arc_id']; ?>)">
                    </td>
                    <td><?php echo $value['cate_name']; ?></td>
                    <td><?php echo date('Y-m-d',$value['sendtime']); ?></td>
                    <td>
                        <div class="btn-group">
                            <button data-toggle="dropdown" class="btn btn-primary btn-xs dropdown-toggle">操作 <span class="caret"></span></button>
                            <ul class="dropdown-menu dropdown-menu-right">
                                <li><a href="<?php echo url('edit',['arc_id'=>$value['arc_id']]); ?>">编辑</a></li>
                                <li class="divider"></li>
                                <li><a href="<?php echo url('delToRecycle',['arc_id'=>$value['arc_id']]); ?>">删除到回收站</a></li>
                            </ul>
                        </div>
                    </td>
                </tr>
