<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:71:"E:\wamp\www\thinkphp\public/../application/admin/view/article/edit.html";i:1496456192;s:63:"E:\wamp\www\thinkphp\public/../application/admin/view/base.html";i:1496560042;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8"/>
    ...
    <nav class="navbar navbar-inverse">
        <div class="container-fluid">
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <h4 style="display: inline;line-height: 50px;float: left;margin: 0px"><a href="<?php echo url('entry/index'); ?>" style="color: white;margin-left: -14px">后盾网武斌博客网</a>
                </h4>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <select class="js-example-basic-single form-control" name="cate_id">
                        ...
                        <?php if(is_array($cateData) || $cateData instanceof \think\Collection || $cateData instanceof \think\Paginator): if( count($cateData)==0 ) : echo "" ;else: foreach($cateData as $key=>$value): ?>
                        <option <?php if($oldData['cate_id']==$value['cate_id']): ?>selected<?php endif; ?> value="<?php echo $value['cate_id']; ?>"><?php echo $value['_cate_name']; ?></option>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <?php if(is_array($tagData) || $tagData instanceof \think\Collection || $tagData instanceof \think\Paginator): if( count($tagData)==0 ) : echo "" ;else: foreach($tagData as $key=>$value): ?>
                    <label class="checkbox-inline">
                        <input type="checkbox" name="tag[]" <?php if(in_array($value['tag_id'],$tag_ids)): ?>checked<?php endif; ?> value="<?php echo $value['tag_id']; ?>"> <?php echo $value['tag_name']; ?>
                    </label>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                </div>
            </div>
